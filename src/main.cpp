...
int main(int argc, char *argv[]) {
  ...
  //
  // objects.push_back(trm::sdfPlane({0.0, 1.0, 0.0, -6.0},
  // matDiff({1.0, 1.0, 1.0}))); objects.push_back(
  //     trm::sdfPlane({0.0, -1.0, 0.0, -25.0}, matEmis(0.0, {1.0, 1.0, 1.0})));
  //
  // for (int i = -10; i < 10; ++i) {
  //   for (int j = 0; j < 20; ++j) {
  //     Float prim = frand();
  //     Float type = frand();
  //     std::shared_ptr<trm::Sdf> primative = nullptr;
  //     if (prim < 0.25) {
  //       primative = trm::sdfSphere(1.0f);
  //     } else if (prim < 0.5) {
  //       primative = trm::sdfBox({0.5f, 0.5f, 0.5f});
  //     } else if (prim < 0.75) {
  //       primative = trm::sdfCylinder(1.0, 0.2);
  //     } else {
  //       primative = trm::sdfTorus({1.0f, 0.3f});
  //     }
  //     if (type < 0.6) {
  ...
  //     // objects.push_back(trm::sdfInfiniteRepeat(primative, {60.0f,
  //     // INFINITY, 60.0f}));
  //   }
  // }
